...
Section "Principal" SEC01
  ...
  File "..\Samples\CLAMDescriptors.sc"
  File "..\Samples\CLAMDescriptors.pro"
...
Section Uninstall
  ...
  Delete "$INSTDIR\example-data\SongsTest\LisaRein-SomethingBetter.mp3"
  Delete "$INSTDIR\example-data\SongsTest\LisaRein-SomethingBetter.mp3.pool"
  Delete "$INSTDIR\example-data\SongsTest\LisaRein-SomethingBetter.mp3.chords"
  Delete "$INSTDIR\example-data\SongsTest\LisaRein-spunkyfunk.mp3"
  Delete "$INSTDIR\example-data\SongsTest\LisaRein-spunkyfunk.mp3.pool"
  Delete "$INSTDIR\example-data\SongsTest\LisaRein-spunkyfunk.mp3.chords"
