...
if not network.ConfigureProcessing(reader, config): print "Could not open the file"
...
network.Start()
time.sleep( clam.MonoAudioFileReader( network.GetProcessing(reader) ).GetLength() )
network.Stop()
