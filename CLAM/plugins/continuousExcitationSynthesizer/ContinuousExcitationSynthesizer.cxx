...
int usage()
{
	std::cout <<
		...
		"Or alternatively build your own database using the program\n"
		"examples of the CLAM framework called WavToSDIF, which converts\n"
		"waves to SDIF files, and SDIFToWavStreaming which prepares such\n"
		"files to assemble a SMS synthesizer database.\n"
		"\n"
		...
		"\n"
		"Databases can be generated by using WavToSDIF and\n"
