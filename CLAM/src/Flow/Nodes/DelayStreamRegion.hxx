...
#ifndef _DELAY_STREAM_REGION_H
#define _DELAY_STREAM_REGION_H
...
namespace CLAM {
	...
	class DelayStreamRegion : public ReadStreamRegion, public SourceStreamRegion {
	public:
		DelayStreamRegion(unsigned int hop,
		                  unsigned int length,
