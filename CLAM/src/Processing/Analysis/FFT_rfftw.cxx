...
namespace Hidden
{
	static const char * metadata[] = {
		"key", "FFT_rfftw",
		"category", "Analysis",
		"description", "FFT_rfftw",
		0
	};
	//static FactoryRegistrator<ProcessingFactory, FFT_rfftw> regFFT_rfftw("FFT_rfftw");
	static FactoryRegistrator<ProcessingFactory, FFT_rfftw> reg = metadata;
}
