...
#ifndef _SpectralPhaseModulation_
#define _SpectralPhaseModulation_
...
namespace CLAM{
	...
	class SpectralPhaseModulation: public FrameTransformationTmpl<Spectrum>
	{
		InPort<Spectrum> mIn;
...
#endif // _SpectralPhaseModulation_
