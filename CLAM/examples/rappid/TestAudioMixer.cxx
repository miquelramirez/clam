...
namespace CLAMTest {
	...
	class AudioMixerTest {
		AudioMixer<3> *mpObject1;
		AudioMixer<3> *mpObject2;
	...
	bool AudioMixerTest::TestConstruction()
	{
		AudioMixerConfig cfg;

		mpObject1 = new AudioMixer<3>();
		mpObject2 = new AudioMixer<3>(cfg);
		return true;
	}

	bool AudioMixerTest::TestConfiguration()
	{
		AudioMixerConfig cfg1,cfg2;
	...
	bool AudioMixerTest::TestExecution()
	{
	...
	bool AudioMixerTest::TestDestruction()
	{
		delete mpObject1;
		delete mpObject2;
		return true;
