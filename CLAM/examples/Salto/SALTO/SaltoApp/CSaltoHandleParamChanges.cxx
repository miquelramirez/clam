...
void CSaltoHandleParamChangesConfig::DefaultInit()
{
	AddAll();	
	UpdateData();
}
...
//CSaltoHandleParamChanges::CSaltoHandleParamChanges(CSaltoParameter* pParams)
  CSaltoHandleParamChanges::CSaltoHandleParamChanges():
  mVelocityIn("Velocity", this, &CSaltoHandleParamChanges::UpdateVelocity),
  mNoteIn("Note", this, &CSaltoHandleParamChanges::UpdateNote),
  mPitchBendIn( "PitchBend", this, &CSaltoHandleParamChanges::UpdatePitchBend ),
  mLastPitch( 0 ),
  mVelocity( 0.0 ),
  mNote( 0.0 ),
  mNoteOff( 0.0 ),
  mPitchBend( 1.0 )
{
	CSaltoHandleParamChangesConfig cfg;
 
	Configure( cfg );
}

CSaltoHandleParamChanges::CSaltoHandleParamChanges( const CSaltoHandleParamChangesConfig& cfg ):
	mVelocityIn("Velocity", this, &CSaltoHandleParamChanges::UpdateVelocity),
	mNoteIn("Note", this, &CSaltoHandleParamChanges::UpdateNote),
	mPitchBendIn( "PitchBend", this, &CSaltoHandleParamChanges::UpdatePitchBend ),
	mLastPitch( 0 ),
...
bool CSaltoHandleParamChanges::ConcreteConfigure( const ProcessingConfig& cfg)throw( std::bad_cast )
{
	mConfig = dynamic_cast< const CSaltoHandleParamChangesConfig& >( cfg );
...
void CSaltoHandleParamChanges::NoteOn(Parameters& params)
{
	double pitchShiftFactor=1;
	short mControl1, mControl2, mControl3, mControl4;

	if (params.GetUseMidiKeyboard()) //   MIDI handling KEYBOARD
    {
...
void CSaltoHandleParamChanges::NoteOff(Parameters& params)
{
...
bool CSaltoHandleParamChanges::Do( Parameters &params )
{
