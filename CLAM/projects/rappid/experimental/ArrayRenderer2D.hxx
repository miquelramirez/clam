...
#ifndef __ARRAYRENDERER2D__
#define __ARRAYRENDERER2D__
...
class ArrayRenderer2D : public Renderer2D
{

public:

	ArrayRenderer2D(const c3f &color);

	virtual ~ArrayRenderer2D() {}

	void SetXLimits(TData x_first, TData x_last);

	void SetDataSize(int size);

	void CacheData(const DataArray& array);
...
protected:
	...
	virtual void DataTransform( const DataArray& array) = 0;
