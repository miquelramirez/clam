...
namespace SALTO
{
	...
	bool AttackResidualSynthesis::ConcreteConfigure( const ProcessingConfig& cfg ) throw( std::bad_cast )
	{
		mConfig = dynamic_cast< const AttackResidualSynthesisConfig& > ( cfg );
