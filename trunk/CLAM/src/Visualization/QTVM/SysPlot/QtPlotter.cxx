...
namespace CLAM
{
	...
	void QtPlotter::Add(const std::string& plotKey, const Audio& leftChannel, const Audio& rightChannel)
	{
	    if(Exist(plotKey))
	    {
		DuplicatedKeyMsg("Add(const std::string& plotKey, const Audio& leftChannel, const Audio& rightChannel)",
				 plotKey);
		return;
	    }
	    QtAppWrapper::Init();
	...
	void QtPlotter::Add(const std::string& plotKey, const Spectrum& spec, const SpectralPeakArray& peaks)
	{
	    if(Exist(plotKey))
	    {
		DuplicatedKeyMsg("Add(const std::string& plotKey, const Spectrum& spec, const SpectralPeakArray& peaks)",
				 plotKey);
		return;
	    }
	    QtAppWrapper::Init();
	...
	void QtPlotter::Add(const std::string& plotKey, const Array<Spectrum>& data, const TData& duration)
	{
	    if(Exist(plotKey))
	    {
		DuplicatedKeyMsg("Add(const std::string& plotKey, const Array<Spectrum>& data, const TData& duration)",
				 plotKey);
		return;
	    }
	    QtAppWrapper::Init();
	...
	void QtPlotter::Add(const std::string& plotKey, const std::string& dataKey, const DataArray& data)
	{
	    if(Exist(plotKey))
	    {
		DuplicatedKeyMsg("Add(const std::string& plotKey, const std::string& dataKey, const DataArray& data)",
				 plotKey);
		return;
	    }
	    QtAppWrapper::Init();
	...
	void QtPlotter::AddData(const std::string& plotKey, const std::string& dataKey, const DataArray& data)
	{
	    ...
	    {
		NonMultiPlotMsg("AddData(const std::string& plotKey, const std::string& dataKey, const DataArray& data)",
				plotKey);
		return;
	    }
