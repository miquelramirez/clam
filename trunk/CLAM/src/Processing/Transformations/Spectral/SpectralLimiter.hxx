...
#ifndef _SpectralLimiter_
#define _SpectralLimiter_
...
namespace CLAM{
	...
	class SpectralLimiter: public FrameTransformationTmpl<Spectrum>
	{
		InPort<Spectrum> mIn;
