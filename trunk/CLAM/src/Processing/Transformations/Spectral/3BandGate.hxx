...
#ifndef _ThreeBandGate_
#define _ThreeBandGate_
...
namespace CLAM{
	...
	class ThreeBandGate: public FrameTransformationTmpl<Spectrum>
	{
		InPort<Spectrum> mIn;
		...
		InControl mLowThresholdCtl;
		InControl mMidThresholdCtl;
		InControl mHighThresholdCtl;
	public:
		const char* GetClassName() const
		{
			return "ThreeBandGate";
		}
