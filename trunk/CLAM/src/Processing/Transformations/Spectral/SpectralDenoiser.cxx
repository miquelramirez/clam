...
bool SpectralDenoiser::Do(const Spectrum& in, Spectrum& out)
{
...
static ProcessingFactory::Registrator<SpectralDenoiser> regtSpectralDenoiser( "SpectralDenoiser" );
