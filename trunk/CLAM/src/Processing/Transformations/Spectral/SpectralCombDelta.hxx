...
#ifndef _SpectralCombDelta_
#define _SpectralCombDelta_
...
namespace CLAM{
	...
	class SpectralCombDelta: public FrameTransformationTmpl<Spectrum>
	{
		InPort<Spectrum> mIn;
		OutPort<Spectrum> mOut;
		
		FloatInControl mFundamentalCtl;
		FloatInControl mLogOverallFactor;
	public:
		const char* GetClassName() const
		{
			return "SpectralCombDelta";
		}
