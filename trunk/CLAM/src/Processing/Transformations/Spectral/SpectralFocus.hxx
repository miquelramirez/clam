...
#ifndef _SpectralFocus_
#define _SpectralFocus_
...
namespace CLAM{
	 ...
	 */
	class SpectralFocus: public FrameTransformationTmpl<Spectrum>
	{
		
		const char *GetClassName() const {return "SpectralFocus";}
