...
#ifndef _Partializer_
#define _Partializer_
...
namespace CLAM{
	...
	class Partializer: public FrameTransformationTmpl<Spectrum>
	{
		InPort<Spectrum> mIn;
		OutPort<Spectrum> mOut;
		
		FloatInControl mFundamentalCtl;
		FloatInControl mFreqSpaceFactorCtl;
	public:
		...
		Partializer()
			...
			mFreqSpaceFactorCtl("FreqSpaceFactor", this)
		{
