...
#ifndef _READ_STREAM_REGION_H
#define _READ_STREAM_REGION_H
...
namespace CLAM {
	...
	class ReadStreamRegion : public StreamRegion {

		SourceStreamRegion *mSource;

	public:

		ReadStreamRegion(unsigned int hop,
		                 unsigned int length,
