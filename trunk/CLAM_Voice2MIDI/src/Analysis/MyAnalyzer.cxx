...
{
	SetprZeroPadding(0);  // default zero padding = 0
	SetWindowSize(513);  // default window size
	SetWindowType(EWindowType::eHamming);  // default window type
...
{   
	...
	mAudioFrame.SetSize(mConfig.GetFFT().GetAudioSize());  // anyadir zero padding
